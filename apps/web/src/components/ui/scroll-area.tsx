...
function ScrollBar({
  ...
  return (
    <ScrollAreaPrimitive.Scrollbar
      ...
      className={cn(
        "flex touch-none p-px transition-colors select-none opacity-0 group-hover/scroll:opacity-100 data-[state=hovered]:opacity-100 data-[state=scrolling]:opacity-100",
